          ...
          <div className="w-full flex flex-col lg:flex-row justify-center shadow-inner">
            ...
            <div className="w-full lg:w-[40%] bg-white rounded-2xl lg:rounded-l-none lg:rounded-r-2xl">
              ...
              <form onSubmit={handleSubmit} className="w-full">
                ...
                <div className="flex justify-end mt-4 px-4 md:px-12">
                  <Link
                    className="font-semibold text-sm md:text-base text-indigo-800 hover:text-indigo-600"
                    to="/forgotpassword"
                  >
                ...
                <div>
                  ...
                  <div className="flex justify-center my-4 gap-2 flex-wrap px-4">
                    <button
                      type="button"
                      onClick={handleGoogleLogin}
                      disabled={loading}
                      className="rounded-full bg-indigo-200 p-1.5 w-fit cursor-pointer hover:bg-indigo-300 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                      <svg
